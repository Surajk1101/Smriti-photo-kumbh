...
export const StudioHero: React.FC<StudioHeroProps> = ({
  ...
  const showcasePhotos = [
    ...
    },
    {
      ...
      label: 'Joyous Haldi Shower',
      shortLabel: 'Haldi Shower',
      title: 'Haldi Ceremony & Marigold Blossom Shower',
      desc: 'Exuberant celebration of the bride and groom bathed in golden turmeric and raining marigold blossoms.',
      isInstagramBest: false,
      aspectClass: 'aspect-[4/3] sm:aspect-[3/2]',
    },
    {
